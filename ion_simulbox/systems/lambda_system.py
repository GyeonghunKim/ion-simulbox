...
class LambdaSystem:
    def __init__(
        ...
        self.n_system = (
            len(lower_states_1) + len(lower_states_2) + len(upper_states) + 1
        )
    ...
    def _setup_atomic_hamiltonian(self):
        ...
        for state in self.upper_states:
            self.H0 = (
                ...
                + 2
                * np.pi
                * (self.reference_state.energy - state.energy)
                / Constants.h
                * self.basis[state]
        ...
        for state in self.lower_states_1:
            self.H0 = (
                ...
                * np.pi
                * (
                    self.laser_1.frequency
                    - (self.reference_state.energy - state.energy) / Constants.h
                )
                * self.basis[state]
                * self.basis[state].dag()
            )
    ...
    def _setup_laser_hamiltonian(self):
        ...
        self.laser_hamiltonians = [self.H_laser_1, self.H_laser_2]
        self.laser_envelope_functions = [
            self.envelope_function_1,
            self.envelope_function_2,
        ]
